...
namespace System.Collections.Generic
{
    ...
    public class FastDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>, ISerializable, IDeserializationCallback where TKey : notnull
    {
            ...
            this(dictionary != null ? dictionary.Count : 0, comparer)
        {
            ...
            // It is likely that the passed-in dictionary is FastDictionary<TKey,TValue>. When this is the case,
            // avoid the enumerator allocation and overhead by looping through the entries array directly.
            // We only do this when dictionary is FastDictionary<TKey,TValue> and not a subclass, to maintain
        ...
        public FastDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection) : this(collection, null) { }

        public FastDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey>? comparer) :
        ...
        public TValue this[TKey key]
        {
            get
            {
                ...
                if (!Unsafe1.IsNullRef(ref value))
                {
                    return value;
                }
        ...
        bool ICollection<KeyValuePair<TKey, TValue>>.Contains(KeyValuePair<TKey, TValue> keyValuePair)
        {
            ...
            if (!Unsafe1.IsNullRef(ref value) && EqualityComparer<TValue>.Default.Equals(value, keyValuePair.Value))
            {
                return true;
            }
            return false;
        ...
        public bool ContainsKey(TKey key)
            => !Unsafe1.IsNullRef(ref FindValue(key));
        ...
        private ref TValue FindValue(TKey key)
        {
            ...
            ref Entry entry = ref Unsafe1.NullRef<Entry>();
            if (buckets != null)
            {
        ...
        Return:
            return ref value;
        ReturnNotFound:
            value = ref Unsafe1.NullRef<TValue>();
            goto Return;
        }
        ...
        public bool TryGetValue(TKey key, [MaybeNullWhen(false)] out TValue value)
        {
            ...
            if (!Unsafe1.IsNullRef(ref valRef))
            {
                value = valRef;
                return true;
            }
