...
namespace System.Collections.Generic
{
    ...
    public class FastHashSet<T> : ICollection<T>, ISet<T>, IReadOnlyCollection<T>, ISerializable, IDeserializationCallback
    {
        ...
        /// <summary>
        /// Used for deep equality of FastHashSet testing
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Adds value to FastHashSet if not contained already
        ...
        // when constructing from another FastHashSet.
        ...
        /// Implementation notes:
        /// 
        /// Used for symmetric except when other isn't a FastHashSet. This is more tedious because 
        /// other may contain duplicates. FastHashSet technique could fail in these situations:
        /// 1. Other has a duplicate that's not in this: FastHashSet technique would add then 
        /// remove it.
        /// 2. Other has a duplicate that's in this: FastHashSet technique would remove then add it
        /// back.
        ...
        /// is only used when other is an IEnumerable and not a FastHashSet. If other is a FastHashSet
